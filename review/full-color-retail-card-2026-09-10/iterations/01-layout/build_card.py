...
def make(path,bleed):
 ...
 for x,y,w,h,col in [(24,126,274,119,'power'),(298,126,278,119,'led'),(24,245,171,213,'sense'),(195,245,145,213,'filter'),(340,245,236,213,'amp'),(24,458,278,99,'power'),(302,458,274,99,'bias')]:
  c.setFillColor(HexColor(C[col]));c.rect(x,600-y-h,w,h,fill=1,stroke=0)
 ...
 t(179,166,'+V',14,True,a='center');l([(179,169),(179,183)]);cap(179,203,'C5','2.2uF',True);g(179,232)
 t(232,174,'+V',14,True,a='center');l([(232,176),(232,185),(237,185)]);diode(262,185,'D2')
 ...
 t(35,283,'SENSE',13,True);t(207,283,'FILTER',13,True);t(354,283,'AMPLIFY',13,True)
 ...
 dot(125,333);l([(125,333),(125,372)]);res(125,396,'R2','12k',vert=True);g(125,432)
 ...
 t(316,477,'BIAS / REFERENCE',13,True)
