...
report={'electrical_terminal_map_matches_native_netlist':True,'terminals_including_NC':len(expected),'diagram_review':'Terminal mapping verified against native netlist; drawn connections visually inspected. All U1, U2 and J1 pins shown, including three intentional U1 no-connects. This checks the independently transcribed terminal map; it is not automated PDF wire extraction.','components':'All 16 references shown. R1 described by function, with no invented resistance.','outputs':{}}
for name,size in [('PulseSensor-complete-schematic-4x4.pdf',288),('PulseSensor-complete-schematic-4x4-bleed.pdf',306)]:
