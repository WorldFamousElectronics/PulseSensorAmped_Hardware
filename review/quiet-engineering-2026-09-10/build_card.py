...
C={'paper': '#f4f1e9', 'ink': '#242a2b', 'soft': '#454b4c', 'red': '#242a2b', 'amber': '#242a2b', 'cyan': '#242a2b', 'violet': '#242a2b', 'panel': '#f4f1e9', 'power': '#e3d0ca', 'led': '#cfd8cc', 'sense': '#d7d7d3', 'filter': '#cbd6d1', 'amp': '#d4d4d4', 'bias': '#dbd4d4'}
def make(path,bleed):
...
for name,b in [('quiet-engineering-retail-purchase-card.pdf',0),('quiet-engineering-retail-purchase-card-bleed.pdf',9)]:make(O/name,b)
