...
colors={'FILTER': '#286c73', 'AMP + GAIN': '#535e7e', 'BIAS': '#75627f', 'LED': '#39745a', 'SENSE': '#657079', 'POWER': '#9e4b50'}
...
(R/'quiet-06-back.svg').write_text(svg)
...
def render(ls,size):
 ...
 return im
render(layers,2400).save(R/'quiet-06-back.png')
...
d.text((65,40),'PulseSensor · WebSerial bright palette study',font=font(52),fill='#152b34');d.text((65,110),'Sheet 29 · Color identifies a functional area · All parts and optical geometry stay in place',font=font(29),fill='#53666d')
for i,(title,p) in enumerate([('PREVIOUS / BRIGHT',R.parent/'led-green-power-red-2026-09-10/led-green-power-red-05-back.png'),('ITERATION / QUIET-06',R/'quiet-06-back.png')]):
