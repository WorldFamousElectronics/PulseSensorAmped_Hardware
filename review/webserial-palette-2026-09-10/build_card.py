...
C=dict(paper='#ffffff',ink='#000000',soft='#333333',red='#000000',amber='#000000',cyan='#000000',violet='#000000',panel='#44ff44',power='#cccccc',led='#ff6b6b',sense='#44ff44',filter='#51cf66',amp='#64c8ff',bias='#ffaa44')
def make(path,bleed):
...
for name,b in [('webserial-full-color-full-schematic-retail-purchase-card.pdf',0),('webserial-full-color-full-schematic-retail-purchase-card-bleed.pdf',9)]:make(O/name,b)
