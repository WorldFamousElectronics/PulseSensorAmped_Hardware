...
for name,size in [('webserial-full-color-full-schematic-retail-purchase-card.pdf',288),('webserial-full-color-full-schematic-retail-purchase-card-bleed.pdf',306)]:
...
new=ET.parse(R/'webserial-04-back.svg').getroot()
...
current=PdfReader(R/'output/pdf/webserial-full-color-full-schematic-retail-purchase-card.pdf')
...
report['color_only']={'board_svg_geometry_identical':True,'card_noncolor_pdf_operators_identical':True,'website_palette_source':'sources/palette-evidence.json'}
(R/'verification.json').write_text(json.dumps(report,indent=2)+'\n')
