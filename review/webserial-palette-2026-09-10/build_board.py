...
colors={'FILTER': '#51cf66', 'AMP + GAIN': '#64c8ff', 'BIAS': '#ffaa44', 'LED': '#ff6b6b', 'SENSE': '#44ff44', 'POWER': '#cccccc'}
...
(R/'webserial-04-back.svg').write_text(svg)
...
def render(ls,size):
 ...
 return im
render(layers,2400).save(R/'webserial-04-back.png')
...
d.text((65,40),'PulseSensor · WebSerial bright palette study',font=font(52),fill='#152b34');d.text((65,110),'Sheet 27 · Color identifies a functional area · All parts and optical geometry stay in place',font=font(29),fill='#53666d')
for i,(title,p) in enumerate([('PREVIOUS / BRAND-03',R.parent/'brand-unification-2026-09-10/brand-03-back.png'),('ITERATION / WEBSERIAL-04',R/'webserial-04-back.png')]):
