...
C={'paper': '#e7ddc8', 'ink': '#000000', 'soft': '#000000', 'red': '#000000', 'amber': '#000000', 'cyan': '#000000', 'violet': '#000000', 'panel': '#ffffff', 'power': '#ff5a5f', 'led': '#44ff44', 'sense': '#ffffff', 'filter': '#c0c0c0', 'amp': '#c0c0c0', 'bias': '#e7ddc8'}
def make(path,bleed):
...
for name,b in [('six-color-retail-purchase-card.pdf',0),('six-color-retail-purchase-card-bleed.pdf',9)]:make(O/name,b)
