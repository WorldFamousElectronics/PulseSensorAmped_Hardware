...
for name,size in [('led-green-power-red-retail-purchase-card.pdf',288),('led-green-power-red-retail-purchase-card-bleed.pdf',306)]:
...
new=ET.parse(R/'led-green-power-red-05-back.svg').getroot()
...
current=PdfReader(R/'output/pdf/led-green-power-red-retail-purchase-card.pdf')
