...
C=dict(paper='#ffffff',ink='#000000',soft='#333333',red='#000000',amber='#000000',cyan='#000000',violet='#000000',panel='#eeeeee',power='#dadada',led='#ff5a5f',sense='#eeeeee',filter='#c0c0c0',amp='#b3b3b3',bias='#fff0f0')
def make(path,bleed):
...
for name,b in [('brand-full-color-full-schematic-retail-purchase-card.pdf',0),('brand-full-color-full-schematic-retail-purchase-card-bleed.pdf',9)]:make(O/name,b)
