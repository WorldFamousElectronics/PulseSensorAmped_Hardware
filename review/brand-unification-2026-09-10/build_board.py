...
colors={'FILTER': '#c0c0c0', 'AMP + GAIN': '#b3b3b3', 'BIAS': '#fff0f0', 'LED': '#ff5a5f', 'SENSE': '#eeeeee', 'POWER': '#dadada'}
...
(R/'brand-03-back.svg').write_text(svg)
...
def render(ls,size):
 ...
 return im
render(layers,2400).save(R/'brand-03-back.png')
...
d.text((65,40),'PulseSensor · PulseSensor brand palette study',font=font(52),fill='#152b34');d.text((65,110),'Sheet 26 · Color identifies a functional area · All parts and optical geometry stay in place',font=font(29),fill='#53666d')
for i,(title,p) in enumerate([('PREVIOUS / MODULES-02',R.parent/'module-outlines-2026-09-10/modules-02-back.png'),('ITERATION / BRAND-03',R/'brand-03-back.png')]):
