...
for name,size in [('brand-full-color-full-schematic-retail-purchase-card.pdf',288),('brand-full-color-full-schematic-retail-purchase-card-bleed.pdf',306)]:
...
new=ET.parse(R/'brand-03-back.svg').getroot()
...
current=PdfReader(R/'output/pdf/brand-full-color-full-schematic-retail-purchase-card.pdf')
